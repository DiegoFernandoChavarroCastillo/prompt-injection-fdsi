...
\midrule
Modelo & [modelo y versión exacta] \\
Modo de acceso & API oficial \\
Temperatura & [valor $>0$; ver Sección III-A] \\
\textit{Top-p} & [valor] \\
Máx. tokens de salida & [valor] \\
Turnos por intento & 1 (\textit{single-turn}) \\
Repeticiones ($N$) & 5 \\
Interacciones totales & 400 \\
Idioma de interacción & Español \\
Lenguaje de implementación & Python 3.x \\
Registro & JSON estructurado por interacción \\
