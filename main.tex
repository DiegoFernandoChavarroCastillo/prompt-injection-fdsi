...
Por ello, el objetivo de este artículo es diseñar, implementar y evaluar comparativamente dos asistentes conversacionales basados en LLM: una línea base vulnerable (sin mecanismos de defensa) y una versión protegida, equipada con una arquitectura de mitigación en capas. Las principales contribuciones de este trabajo se resumen a continuación:

\begin{itemize}
    \item Se diseña e implementa un chatbot vulnerable que actúa como entorno de control, carente de defensas contra la inyección directa de instrucciones.
...
(\textit{baseline} vulnerable), sin ningún mecanismo de mitigación, y la
...
\begin{itemize}
    ...
    (A: vulnerable / B: protegido). Es la \emph{única} dimensión que
...
\node[cond, text width=1.9cm, fill=black!5] (ca) at (0,-3.0)
  {Condición A\\\tiny Chatbot vulnerable};
...
\subsection{Arquitectura del chatbot vulnerable (condición A)}
