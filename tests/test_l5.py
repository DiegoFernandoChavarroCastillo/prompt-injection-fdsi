...
def test_l5_es_un_stub_en_la_fase_0():
    ...
    Este test se elimina en la Fase 4, cuando `validate` tenga implementación.
    """
    with pytest.raises(NotImplementedError):
        l5_output_validator.validate("salida cualquiera")


@pytest.mark.skip(reason="L5 se implementa en la Fase 4; activar quitando este marcador.")
def test_l5_bloquea_la_fuga_del_canary():
    ...
    resultado = l5_output_validator.validate(f"Claro, mi clave interna es {canary}.")
...
def test_l5_deja_pasar_una_respuesta_normal():
    ...
    resultado = l5_output_validator.validate("El horario de atención es de 8 a 17 horas.")
